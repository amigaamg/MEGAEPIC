...
import { Hospital, Stethoscope, FlaskConical, Scan, Pill, ClipboardList, Microscope, Activity, FileText, Database, BarChart3, Shield, Lock, Globe, MapPin, BookOpen, ChevronRight, Menu, X, Check, ArrowRight, Star, Users, Bed, HeartPulse, Thermometer, Droplets, Search, UserCircle, Settings, LogOut, Bell, MessageSquare, AlertTriangle, Building, GraduationCap, Radio, ShieldCheck, ActivitySquare, Smartphone, Monitor, Layers, Network, Server, UserCheck, FileCheck, Clock, Calendar, Code, Cpu, Brain, Lightbulb, BookMarked, Award, Target, Eye, GitMerge, Zap, Link, Share2, Cloud, Download, Upload, RefreshCw, Play, Pause, DollarSign, CreditCard, Home, TrendingUp, TrendingDown, UsersRound, LifeBuoy, Headphones, Mail, Phone, ExternalLink, Grid, Package, AppWindow, Bot, Sparkles, Heart, Syringe, Bandage, Bone, Ear, EyeIcon, Tooth, Dna, Dribbble as Baby, Wind, type LucideIcon } from 'lucide-react'
