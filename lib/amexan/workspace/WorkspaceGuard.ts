...
const CATEGORY_FAMILY: Readonly<Record<string, WorkspaceFamily>> = {
  ...
  community_health_worker: 'community_health',
  physiotherapist: 'clinical',
  occupational_therapist: 'clinical',
  nutritionist: 'clinical',
  dietitian: 'clinical',
  social_worker: 'clinical',
  psychologist: 'clinical',
  receptionist: 'department',
  records_officer: 'department',
  supplier: 'finance' as WorkspaceFamily,
  organisational_admin: 'executive',
  org_admin: 'executive',
  organization_admin: 'executive',
  administrative: 'executive',
  admin_officer: 'executive',
  assistant_administrator: 'executive',
  radiology_technologist: 'radiology',
  lab_tech: 'laboratory',
  laboratory_technician: 'laboratory',
  medical_laboratory_technician: 'laboratory',
  cashier: 'finance',
  accountant: 'finance',
  ...
  it_support: 'ict',
  network_engineer: 'ict',
  software_engineer: 'ict',
  data_entry_officer: 'department',
  front_desk_officer: 'department',
  patient: 'patient',
  guardian: 'patient',
};
...
const FAMILY_ALIASES: Readonly<Record<string, WorkspaceFamily>> = {
  ...
  lab: 'laboratory',
  lab_tech: 'laboratory',
  laboratory_technologist: 'laboratory',
  medical_laboratory_scientist: 'laboratory',
  radiology: 'radiology',
  imaging: 'radiology',
  radiographer: 'radiology',
