...
export const DISEASES = [
  ...
  { id:"eclampsia", name:"Eclampsia", color:"#d946ef" },
  { id:"inguinal_hernia", name:"Inguinal Hernia", color:"#f97316" },
  { id:"umbilical_hernia", name:"Umbilical Hernia", color:"#fb923c" },
  { id:"hiatal_hernia", name:"Hiatal Hernia", color:"#fdba74" },
  { id:"cushing_disease", name:"Cushing's Disease", color:"#a21caf" },
  { id:"bipolar_disorder", name:"Bipolar Disorder", color:"#6366f1" },
  { id:"ovarian_cancer", name:"Ovarian Cancer", color:"#ec4899" },
];
...
export const ALL_SYMPTOMS = [
  ...
  { id:"seizures", label:"Seizures", warn:true },
  { id:"oliguria", label:"Oliguria" },
  { id:"peripheral_oedema", label:"Peripheral Oedema" },
  { id:"sudden_weight_gain", label:"Sudden Weight Gain" },
  { id:"bulge_groin", label:"Groin Bulge" },
  { id:"bulge_umbilicus", label:"Umbilical Bulge" },
  { id:"dragging_sensation", label:"Dragging Sensation" },
  { id:"heartburn", label:"Heartburn" },
  { id:"regurgitation", label:"Regurgitation" },
  { id:"dysphagia", label:"Dysphagia" },
  { id:"moon_face", label:"Moon Face" },
  { id:"buffalo_hump", label:"Buffalo Hump" },
  { id:"central_obesity", label:"Central Obesity" },
  { id:"easy_bruising", label:"Easy Bruising" },
  { id:"purple_striae", label:"Purple Striae" },
  { id:"muscle_weakness_proximal", label:"Proximal Muscle Weakness" },
  { id:"osteoporosis", label:"Osteoporosis" },
  { id:"hyperglycaemia", label:"Hyperglycaemia" },
  { id:"hypertension", label:"Hypertension" },
  { id:"elated_mood", label:"Elated Mood" },
  { id:"depressed_mood", label:"Depressed Mood" },
  { id:"pressured_speech", label:"Pressured Speech" },
  { id:"decreased_sleep", label:"Decreased Sleep" },
  { id:"grandiosity", label:"Grandiosity" },
  { id:"flight_of_ideas", label:"Flight of Ideas" },
  { id:"increased_activity", label:"Increased Activity" },
  { id:"poor_judgement", label:"Poor Judgement" },
  { id:"suicidal_ideation", label:"Suicidal Ideation", warn:true },
  { id:"abdominal_bloating", label:"Abdominal Bloating" },
  { id:"early_satiety", label:"Early Satiety" },
  { id:"pelvic_pain", label:"Pelvic Pain" },
  { id:"abnormal_vaginal_bleeding", label:"Abnormal Vaginal Bleeding" },
  { id:"urinary_frequency", label:"Urinary Frequency" },
