...
function mapFirebaseError(code: string): string {
  return (
    FIREBASE_ERRORS[code] ?? "Registration failed. Please try again."
  );
}

// ─── Sub‑components (reused from login) ────────────────────────────────────
...
export default function RegisterPage() {
  ...
  const enterKey = (e: React.KeyboardEvent) => {
    if (e.key === "Enter" && !busy) handleRegister();
  };
        ...
        <aside className="amx-panel">
          ...
          <div className="amx-panel-body">
            ...
            <p className="amx-panel-sub">
              Create your account in seconds. Already trusted by thousands of
        ...
        <main className="amx-form-wrap">
          <div className="amx-form-inner">
            ...
            <div className="amx-form-top">
              <div className="amx-eyebrow">Get started</div>
              <h2 className="amx-form-h">Create your account</h2>
              <p className="amx-form-sub">
                Fill in the details below to get instant access.
              </p>
            </div>
            ...
            <div className="amx-divider">
              ...
              <span className="amx-divider-text">or sign up with email</span>
              <div className="amx-divider-line" />
            </div>
            ...
            <div className="amx-field">
              <label className="amx-field-label" htmlFor="name">
                Full name
              </label>
              <InputField
                id="name"
            ...
            {/* Email */}
            <div className="amx-field">
              <label className="amx-field-label" htmlFor="email">
                Email address
              </label>
              <InputField
                id="email"
            ...
            {/* Confirm Password */}
            <div className="amx-field">
              <label className="amx-field-label" htmlFor="confirmPassword">
                Confirm password
              </label>
              <InputField
                id="confirmPassword"
                ...
                rightSlot={
                  ...
                  >
                    <i
                      className={`ti ${confirmPwVisible ? "ti-eye-off" : "ti-eye"}`}
                      aria-hidden="true"
                    />
                  </button>
                }
            ...
            {/* Role */}
            <div className="amx-field">
              <label className="amx-field-label" htmlFor="role">
                I am a…
              </label>
              <div className="amx-input-wrap">
                <i className="ti ti-stethoscope amx-input-icon" aria-hidden="true" />
                <select
                  id="role"
                  className="amx-select"
                  value={role}
...
// ─── CSS-in-JS (reused from login – full international design) ─────────────
...
const CSS = `
  ...
  .amx-field-label { font-size: 13px; font-weight: 500; color: #0D0D12; margin-bottom: 7px; display: block; }
  ...
  .amx-select {
    flex: 1; border: none; outline: none; background: transparent;
    font-size: 15px; color: #0D0D12; font-family: 'DM Sans', sans-serif;
    cursor: pointer; appearance: none;
    background-image: url("data:image/svg+xml,%3Csvg width='10' height='6' viewBox='0 0 10 6' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M1 1L5 5L9 1' stroke='%239090A0' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E");
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .amx-select { color: #F0EFEC; background-image: url("data:image/svg+xml,%3Csvg width='10' height='6' viewBox='0 0 10 6' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M1 1L5 5L9 1' stroke='%23565666' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E"); }
