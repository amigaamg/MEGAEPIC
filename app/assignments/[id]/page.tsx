      ...
      <div style={{ padding: 24, maxWidth: 700, margin: '0 auto' }}>
        <div style={{ padding: 20, background: 'var(--surface-card)', borderRadius: 12, border: '1px solid var(--surface-border)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <div style={{ display: 'flex', gap: 10, padding: '8px 12px', borderRadius: 6, background: 'var(--surface)', border: '1px solid var(--surface-border)', fontSize: 12, alignItems: 'center' }}><MapPin size={14} color="#10B981" /> <strong>Location:</strong> Ward 4, Kisii Teaching & Referral Hospital</div>
