...
.cos-nav-btn:hover{background:var(--sky-600);transform:translateY(-1px)}

/* Hero */
.cos-hero{max-width:1200px;margin:80px auto 0;padding:80px 24px 60px;text-align:center}
.cos-eyebrow{display:inline-flex;align-items:center;gap:8px;background:var(--sky-50);border:1px solid var(--sky-200);padding:6px 16px;border-radius:100px;font-size:12px;font-weight:600;color:var(--sky-700);margin-bottom:24px;animation:fadeUp .6s}
.cos-dot{width:6px;height:6px;border-radius:50%;background:var(--sky-500);animation:pulse-dot 1.5s infinite}
.cos-h1{font-size:52px;font-weight:800;letter-spacing:-1.5px;color:var(--sky-900);line-height:1.08;margin-bottom:16px;animation:fadeUp .6s .1s both}
.cos-h1 em{color:var(--sky-500);font-style:normal}
.cos-p{font-size:18px;color:var(--frost-500);max-width:600px;margin:0 auto 32px;line-height:1.7;animation:fadeUp .6s .2s both}
.cos-hero-actions{display:flex;gap:12px;justify-content:center;flex-wrap:wrap;animation:fadeUp .6s .3s both}
...
.cos-btn-primary:hover{background:var(--sky-600);transform:translateY(-2px);box-shadow:var(--shadow-md)}
...
.preview-card:hover{box-shadow:var(--shadow-lg);transform:translateY(-2px)}
...
.timeline-section .cos-section-title{color:var(--sky-900)}
...
.timeline-node{flex-shrink:0;width:140px;text-align:center;position:relative}
.timeline-item-icon{width:48px;height:48px;border-radius:50%;margin:0 auto 8px;display:flex;align-items:center;justify-content:center;font-size:20px}
...
.cos-footer-btn.white:hover{transform:translateY(-2px);box-shadow:0 8px 24px rgba(0,0,0,.2)}
...
export default function CosLanding() {
  const timeline = [
    { icon: "👤", label: "Patient Arrives", time: "08:01", type: "data" },
    { icon: "🌡️", label: "Vitals Taken", time: "08:05", type: "data" },
    { icon: "📖", label: "History Captured", time: "08:08", type: "data" },
    { icon: "🔍", label: "Examination", time: "08:25", type: "data" },
    { icon: "🧪", label: "Investigations", time: "08:40", type: "data" },
    { icon: "🔗", label: "Evidence Graph", time: "09:30", type: "intel" },
    { icon: "🧠", label: "Clinical Reasoning", time: "09:45", type: "intel" },
    { icon: "🎯", label: "Diagnosis", time: "09:47", type: "intel" },
    { icon: "💊", label: "Treatment Ordered", time: "09:49", type: "outcome" },
    { icon: "🩸", label: "Transfusion", time: "10:15", type: "outcome" },
    { icon: "✅", label: "Recovery", time: "14:00", type: "outcome" },
    { icon: "🚪", label: "Discharge", time: "Day 4", type: "outcome" },
  ];

  const roles = [
    {
      icon: "👨‍⚕️", name: "Doctor", answer: "What do I need to do now?",
      desc: "Ward round mode with bed-by-bed presentation. Review, decide, plan. One click updates notes, orders, and to-do lists. Never navigate modules — just work.",
      tags: ["Ward Round", "One-Click Decisions", "Auto Documentation"]
    },
    {
      icon: "👩‍⚕️", name: "Nurse", answer: "What is due for this patient?",
      desc: "Task-oriented workflow. Patients appear in order of need — medication round, vitals, fluid balance, escalations. No searching, just doing.",
      tags: ["Medication Round", "Vitals", "Escalations"]
    },
    {
      icon: "🧪", name: "Laboratory", answer: "Which samples need attention?",
      desc: "Specimen-based workflow: Received → Processing → Verified → Released. Critical alerts auto-notify clinicians. Lab never needs the patient history — just the sample.",
      tags: ["Specimen Tracking", "QC", "Critical Alerts"]
    },
    {
      icon: "💊", name: "Pharmacy", answer: "Is this order safe?",
    ...
    {
      icon: "🩻", name: "Radiology", answer: "What is the clinical question?",
    ...
    {
      icon: "🏗️", name: "Administration", answer: "How is the hospital running?",
    ...
    <>
      ...
      <header className="cos-top">
        <div className="cos-top-inner">
          ...
          <nav className="cos-nav">
            ...
            <a href="/amexan-constitution" className="cos-nav-btn">📜 Constitution →</a>
          </nav>
        </div>
      </header>
      ...
      <section className="cos-hero">
        ...
        <div className="cos-hero-actions">
          <a href="/dashboard/cos-doctor" className="cos-btn-primary">⚕️ Doctor Dashboard →</a>
          <a href="/dashboard/cos-nurse" className="cos-btn-outline">👩‍⚕️ Nurse →</a>
          <a href="/dashboard/cos-lab" className="cos-btn-outline">🧪 Lab →</a>
          <a href="/dashboard/cos-pharmacy" className="cos-btn-outline">💊 Pharmacy →</a>
          <a href="/dashboard/cos-radiology" className="cos-btn-outline">🩻 Radiology →</a>
          <a href="/dashboard/cos-admin" className="cos-btn-outline">🏗️ Admin →</a>
          <a href="/cos-patient-portal" className="cos-btn-outline">💙 Portal →</a>
          <a href="/amexan-constitution" className="cos-btn-outline">📜 Constitution →</a>
        </div>
      </section>
        ...
        <div className="preview-grid">
          <a href="/dashboard/cos-doctor" className="preview-card" style={{textDecoration:'none',color:'inherit'}}>
            ...
            <div className="preview-body">
              ...
              <div className="preview-stat"><span>⚠️ Critical</span><span>2</span></div>
          ...
          <a href="/dashboard/cos-nurse" className="preview-card" style={{textDecoration:'none',color:'inherit'}}>
            ...
            <div className="preview-body">
              ...
              <div className="preview-stat"><span>🌡️ Vitals Due</span><span>8</span></div>
              <div className="preview-stat"><span>⚠️ Escalations</span><span>2</span></div>
              <div className="preview-beds">
                {[
      ...
      <footer className="cos-footer">
        ...
        <div className="cos-footer-actions">
          <a href="/dashboard/cos-doctor" className="cos-footer-btn white">⚕️ Doctor →</a>
          <a href="/dashboard/cos-nurse" className="cos-footer-btn white">👩‍⚕️ Nurse →</a>
          <a href="/dashboard/cos-lab" className="cos-footer-btn white">🧪 Lab →</a>
          <a href="/dashboard/cos-pharmacy" className="cos-footer-btn white">💊 Pharmacy →</a>
          <a href="/dashboard/cos-radiology" className="cos-footer-btn white">🩻 Radiology →</a>
          <a href="/dashboard/cos-admin" className="cos-footer-btn white">🏗️ Admin →</a>
          <a href="/cos-patient-portal" className="cos-footer-btn outline">💙 Patient Portal</a>
          <a href="/amexan-constitution" className="cos-footer-btn outline">📜 Constitution</a>
        </div>
      </footer>
    </>
  );
