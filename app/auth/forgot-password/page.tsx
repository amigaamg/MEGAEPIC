        ...
        <main className="amx-form-wrap">
          <div className="amx-form-inner">
            ...
            <div className="amx-form-top">
              <div className="amx-eyebrow">Password reset</div>
              <h2 className="amx-form-h">Forgot password?</h2>
            ...
            {sent ? (
              ...
              <>
                ...
                >
                  {loading ? (
                    <><div className="amx-spin" /> Sending link…</>
                  ) : cooldown > 0 ? (
...
const CSS = `
  ...
  .amx-success-box {
    ...
    font-size: 13px; color: #166534; line-height: 1.5; margin-bottom: 16px;
  }
  .amx-success-box i { flex-shrink: 0; font-size: 20px; margin-top: 1px; color: #22C55E; }
  .amx-success-box strong { display: block; margin-bottom: 2px; }
  .amx-success-box p { margin: 0; color: #15803D; }
  ...
  @media (max-width: 480px) {
    ...
    .amx-btn-primary, .amx-input-wrap { height: 48px; }
  }
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .amx-success-box { background: #052E16; border-color: #166534; color: #86EFAC; }
    .amx-success-box i { color: #22C55E; }
    .amx-success-box p { color: #4ADE80; }
